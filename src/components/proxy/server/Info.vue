      ...
      <div slot="title" class="title">
        ...
        <div>
          <el-tooltip placement="top">
            ...
            <el-popconfirm :title="'确定要删除该转发端口[' + info.name + ']吗？'" @confirm="onDeleteServerConfirm">
        ...
        <div>
          <el-tooltip placement="top">
            ...
            <el-button class="icon-btn" type="text" icon="el-icon-edit-outline" @click.stop="onShowServerEditDlg"/>
          </el-tooltip>
        </div>
      </div>
      <div>
